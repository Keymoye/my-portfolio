...
function NavBar({}: NavBarProps) {
  ...
  return (
    <>
      <motion.nav
        className="bg-foreground p-4 justify-between items-center hidden md:flex fixed z-50 top-0 left-0 w-full "
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      >
        <div className="flex justify-center items-center space-x-2">
          <Link
            to="/"
            className="flex items-center hover:bg-muted px-2 py-1 rounded transition-all"
          >
            <motion.div
        ...
        <div className="flex items-center md:space-x-6 lg:space-x-8 text-base lg:text-lg font-medium text-background">
          <Link
            to="/project"
            className="hover:bg-accent px-3 py-2 rounded transition-all hover:scale-105"
          >
            Project
          </Link>
          <Link
          ...
          <a
            ...
            className="hover:bg-muted bg-primary px-3 py-2 rounded transition-all hover:scale-105"
          >
            Resume
          </a>
          <ThemeToggle />
      ...
      {/* Mobile Navigation */}
      <motion.nav
        className="bg-foreground px-4 h-20 flex md:hidden justify-between items-center fixed z-50 top-0 left-0 w-full"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ type: 'spring', stiffness: 100, damping: 20 }}
      >
